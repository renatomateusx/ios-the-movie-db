...
public struct MovieCollectionViewModelInputs{
    ...
    let collectionTypeSelected: Driver<MDMovieCollection>
}
...
public final class MovieCollectionViewModel: MovieCollectionViewModelType, MovieCollectionViewModelOutputs {
    ...
    private func fetchMovies(by collectionType: MDMovieCollection){
        _movies.accept([])
       _isFetching.accept(true)
        _error.accept(nil)
        
        inputs.movieRepository.fetchMovieCollection(by: collectionType, successHandler: {[weak self] (response) in
